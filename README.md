...
```
"io.savolainen.uicomponents": "https://github.com/jonisavo/uicomponents.git#upm/v1.0.0-beta.6"
```

This will install version 1.0.0-beta.6.

To update, change `upm/v1.0.0-beta.6` to point to the latest version.

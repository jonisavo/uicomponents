...
```json
{
    ...
    "dependencies": {
        "io.savolainen.uicomponents": "0.21.0"
    }
}
```
...
```
"io.savolainen.uicomponents": "https://github.com/jonisavo/uicomponents.git#upm/v0.21.0"
```

This will install version 0.21.0.

To update, change `upm/v0.21.0` to point to the latest version.
